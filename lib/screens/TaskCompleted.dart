...
Future<List<Data>> fetchData(
  ...
  var url = Uri.parse(AppString.constanturl + 'get_completedtask');
...
void main() async {
  ...
  runApp(MaterialApp(
    ...
    home: CompletedTask(admin_type: adminttype.toString()),
  ));
}
...
class CompletedTask extends StatelessWidget {
  ...
  CompletedTask({required this.admin_type});
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Completed(admin_type: admin_type),
    );
  }
}
...
class Completed extends StatefulWidget {
  final String admin_type;
  const Completed({Key? key, required this.admin_type}) : super(key: key);
